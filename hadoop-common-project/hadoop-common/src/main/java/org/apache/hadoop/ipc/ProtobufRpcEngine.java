  ...
  public static class Server extends RPC.Server {
    ...
    static class ProtoBufRpcInvoker implements RpcInvoker {
      ...
      public Writable call(RPC.Server server, String protocol,
        ...
        YML.debug("Call Detail",protocol,protoName,methodName,clientVersion);
        if (server.verbose){
          YML.debug("Call: protocol=" + protocol + ", method=" + methodName);
        ...
        try {
          ...
          YML.debug("Service Class", service.getClass());
